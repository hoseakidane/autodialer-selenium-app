			 ...
			 ('senior' in titlelist) or ('ml' in titlelist) or ('ds' in titlelist) or ('de' in titlelist) or ('lead' in titlelist) or\
			  ('sr' in titlelist) or ('principal' in titlelist) or ('engineer' in titlelist) or ('vp' in titlelist) or\
			   ('director' in titlelist) or ('director' in titlelist) or ('analytics' in titlelist):
				...
				# inserting code to make it do a double call before it logs the call and moves on 
				...
				# Log 2nd call in iframe fix, still unable
				# dropdown2 = driver.find_element(By.XPATH, "//*[@id="dialerBody"]/div[2]/div[4]/div[1]/div[2]/div/div/div")
				# dropdown2.click()
				# time.sleep(0.75)
				# dropdown2.send_keys('Call No Answer')
				# time.sleep(0.75)
				# dropdown2.send_keys(Keys.RETURN) 
				# logcalliframe = driver.find_element(By.XPATH, "//*[@id="callLogFooter"]/div[2]/button[2]")
				# logcalliframe.click()
